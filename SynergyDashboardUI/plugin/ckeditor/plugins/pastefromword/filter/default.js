                ...
                elements: {
                    ...
                    p: function (a) {
                        ...
                        if (g.thisIsAListItem(b, a)) t.isEdgeListItem(b, a) && t.cleanupEdgeListItem(a), g.convertToFakeListItem(b,
                            a), m.array.reduce(a.children, function (a, b) {
                    ...
                    ul: function (a) {
                        if (d) return "li" == a.parent.name && 0 === m.indexOf(a.parent.children, a) && k.setStyle(a.parent, "list-style-type", "none"), g.dissolveList(a), !1
                    },
                    li: function (a) {
                    ...
                    span: function (a) {
                        ...
                        if (!a.attributes.style ||
                            a.attributes.style.match(/^mso\-bookmark:OLE_LINK\d+$/) || a.getHtml().match(/^(\s|&nbsp;)+$/)) {
                    ...
                    "v:shape": function (a) {
                        ...
                        if (null === a.getFirst("v:imagedata")) c(a);
                            ...
                            if (b) return !1;
                            var d = "";
                            "v:group" === a.parent.name ? c(a) : (a.forEach(function (a) {
    ...
    CKEDITOR.plugins.pastefromword.styles = {
        ...
        inliner: {
            ...
            parse: function (a) {
                ...
                var f;
                if (h)
                    for (h = h.cssRules, f = 0; f < h.length; f++) h[f].type === window.CSSRule.STYLE_RULE && a.push({
    ...
    CKEDITOR.plugins.pastefromword.lists = {
        ...
        removeSymbolText: function (a) {
            ...
            a.forEach(function (e) {
                !d && -1 < e.value.indexOf(b) && (d = !0, e.value = e.value.replace(b, ""), e.parent.getHtml().match(/^(\s|&nbsp;)*$/) ? c = e.parent !== a ? e.parent : null : e.value || (c = e))
            }, CKEDITOR.NODE_TEXT);
            c && c.remove()
        },
        ...
        createLists: function (a) {
            ...
            for (a = 0; a < h.length; a++) {
                ...
                for (d = 0; d <
                    ...
                    for (c = b.attributes["cke-list-level"]; c > l.length;) {
                        var r = g.createList(b),
                            m = k.children;
                        0 < m.length ? m[m.length - 1].add(r) : (m = new CKEDITOR.htmlParser.element("li", {
                ...
                l[0].children.length && (d = l[0].children[0].attributes["cke-symbol"],
                    !d && 1 < l[0].children.length && (d = l[0].children[1].attributes["cke-symbol"]), d && g.setListSymbol(l[0], d));
        ...
        dissolveList: function (a) {
            ...
            g = h.reduce(g, function (a, b) {
                ...
                if (c && c.name && c.attributes.style && c.attributes.style.match(/mso-list:/i)) {
                    ...
                    (c = d.display ? "display" : d.DISPLAY ? "DISPLAY" : "") && k.setStyle(b, "display", d[c],
                        !0)
                }
        ...
        assignListLevels: function (a, b) {
            if (!b.attributes || void 0 === b.attributes["cke-list-level"]) {
                ...
                var k = f(c, function (a, b) {
                    ...
                    m = this.guessIndentationStep(h.filter(c, function (a) {
                        return 0 !== a
                    })),
                    e = f(c, function (a) {
                        return Math.round(a / m)
                    }); - 1 !== h.indexOf(e, 0) && (e = f(e, function (a) {
                    return a + 1
                }));
