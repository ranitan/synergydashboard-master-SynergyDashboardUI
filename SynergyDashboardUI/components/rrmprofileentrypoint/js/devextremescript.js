...
function renderProfilePopup() {
              var editor = $("#txtareaComments").dxHtmlEditor({
                  height: 400,
                  mentions: [{
                    dataSource: candidateProfileMentions,
                    searchExpr: "CandidateName",
    ...
    var editor = $("#bantxtareaComments").dxHtmlEditor({
        height: 400,
        toolbar: {
            items: [
                "undo", "redo", "separator",
    ...
    $("#rrm_candidatenoticeperiod").dxNumberBox({
    ...
    $("#rrm_candidatereferral").dxTextBox({
        placeholder:"Referral",
        showClearButton:true
    })

    $("#rrm_candidateTotalExperience").dxNumberBox({
    ...
    function checkIfCandidateExist(emailId) {   
        ...
        callGetListAsync('CheckIfCandidateProfileExists', filterData, function (e) {
            $("#rrm_existingcandidateByEmail").dxDataGrid({ dataSource: e })
            if(e.length>0){
    ...
    function rrm_ExistingCandidateProfile() {
        ...
        var dataGrid = $("#rrm_existingcandidateByEmail").dxDataGrid({
             filterRow: {
               visible: true,
               applyFilter: "auto"
            },
    ...
    $("#rrm_candidatephoneno").dxNumberBox({
        format: "#",
    ...
    $("#rrm_candidatepassportno").dxTextBox({
        placeholder: "Passport Number",
        showClearButton: true,
        maxLength: 15
    });
    $("#rrm_candidateaadharno").dxNumberBox({
        format: "#",
    ...
    $("#rrm_candidatepanno").dxTextBox({
        placeholder: "Pan Number",
        showClearButton: true,
        maxLength: 20
    });
    //carrer details tab
    $("#rrm_currentcompany").dxTextBox({
        placeholder: "Current Company",
        showClearButton: true,
    });
    $("#rrm_currentdesignation").dxTextBox({
        placeholder: "Designation",
        showClearButton: true,
    });
    $("#rrm_expinyears").dxTextBox({
        placeholder: "Experience in Year",
        showClearButton: true,
    });
    $("#rrm_currentlocation").dxTextBox({
        placeholder: "Current Loaction",
        showClearButton: true,
    });
    $("#rrm_native").dxTextBox({
        placeholder: "Native",
        showClearButton: true,
    });
    ...
    $("#rrm_candidateskype").dxTextBox({
        placeholder: "Skype",
        showClearButton: true,
    });
    $("#rrm_candidatelinkedin").dxTextBox({
        placeholder: "LinkedIn",
        showClearButton: true,
    });
    $("#rrm_candidategithub").dxTextBox({
        placeholder: "GitHub",
        showClearButton: true,
    });
    $("#rrm_candidateurl").dxTextBox({
        placeholder: "URL",
        showClearButton: true,
    });
    $("#rrm_candidatefathername").dxTextBox({
    ...
    //address details
    $("#rrm_candidateaddress").dxTextBox({
        placeholder: "Address",
        showClearButton: true,
    });
    $("#rrm_candidatecity").dxSelectBox({
        displayExpr: "Name",
    ...
    $("#rrm_candidatepstate").dxSelectBox({
        displayExpr: "Name",
        dataSource: getstate,
        valueExpr:"Id",
        searchEnabled: true,
        ...
        onItemClick: function (e) {
            $("#rrm_candidatecity").dxSelectBox("instance").option("value","");
            loadcities(e.itemData.Id);
        }
    });
    $("#rrm_candidatecountry").dxSelectBox({
        displayExpr: "Name",
        ...
        showClearButton: true,
        onItemClick: function (e) {
            $("#rrm_candidatepstate").dxSelectBox("instance").option("value","");
            loadstate(e.itemData.Id);
        }
    });
    $("#rrm_candidatepincode").dxTextBox({
        placeholder: "Pin Code",
        showClearButton: true,
    });

    $("#rrm_bancandidate").dxSelectBox({
        displayExpr: "Name",
        valueExpr: "Id",
