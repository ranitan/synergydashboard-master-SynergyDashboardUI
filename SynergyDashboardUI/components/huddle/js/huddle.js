...
function huddledataList() {  
  //GethuddleList = callgetlist('GethuddleList', '{"IsActive":"True"}');
...
{      
    var dataGrid = $("#huddleList").dxDataGrid({
        dataSource: GethuddleList,
        filterRow: {
            visible: true,
            applyFilter: "auto"
        },     
        export: {
          ...
          onExporting: function(e) {
            ...
            var worksheet = workbook.addWorksheet('huddle');
            ...
            DevExpress.excelExporter.exportDataGrid({
              ...
              workbook.xlsx.writeBuffer().then(function(buffer) {
                saveAs(new Blob([buffer], { type: 'application/octet-stream' }), 'huddle.xlsx');
              });
            });
            e.cancel = true;
          },
