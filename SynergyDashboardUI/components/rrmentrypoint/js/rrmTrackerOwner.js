...
$(document).on("click", "#rrm_entryPointRemarksId", function (e) {
    ...
    $('#rrm_rrmEntryPoint_remarks').appendTo("body").modal("show");
    $("#remarksBodyRRMEntryPoint").empty();
    $("#remarksBodyRRMEntryPoint").html(remark);
  })
  
  function closeRRMEntryPoint(){
    $('#rrm_rrmEntryPoint_remarks').modal("hide");
    $("#remarksBodyRRMEntryPoint").empty();
  }
