 ...
 function renderbenchtobillingreportGrid(){
    ...
    var dataGrid = $("#sddgd-benchtobillingreport").dxDataGrid({
        ...
        columns: [
            {caption:"Employee Name", dataField:"CompanyName"},
            {caption:"Employee Code", dataField:"Phone"},
            {caption:"Technology", dataField:"Fax"},
            {caption:"Backup Lead", dataField:"City"},
            {caption:"Bench Start Date", dataField:"State"}           
        ]
    }).dxDataGrid("instance");
}