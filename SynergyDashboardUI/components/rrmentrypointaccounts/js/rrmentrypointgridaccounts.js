RRMEntryPointGridAccounts = (function(pageId){
    var _rrmGrid = {}
    _rrmGrid.ui ={};
    ...
    function renderrrmentrypointreportGrid(){
        var dataGrid = _rrmGrid.ui.rrmGridReport.dxDataGrid({
            ...
            columns: [
                ...
                //{caption:"Recriter(HR name)", dataField:"Recriter", hidingPriority: 0},
                ...
                { caption: "Joining Date",
                 dataField: "JoiningDate", dataType: "date",format : "dd-MMM-yyyy"
                    },
                ...
                cellTemplate: function (container, options) {
                    ...
                    $("<div>")
                        .append("<button data-type='edit' data-rrmid =" + options.value + " data-rrmtypeaccounts =" + options.data.ResourceRequirementType + " class='btn btn-xs btn-primary edit-btn btnSelect editRRMEntryPoint"+pageId+"'><i class='fas fa-pencil-alt'></i></button>")
                    .appendTo(container);
                    },
                onClick: function (e) {
    ...
    _rrmGrid.getRRMEntryTable = function() {
        ...
        callGetListAsync('GetRRMForAccounts', filterData, function(e){
