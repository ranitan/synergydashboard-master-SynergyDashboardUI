...
AddCloneRRMEntryPoint = (function () {
    var _addCloneRRMEntryPoint = {};
    var GetRRMs;
    var dataResource = [];
    var dataPlanA = [];
    var dataPlanB = [];
    ...
    _addCloneRRMEntryPoint.family = {};
    _addCloneRRMEntryPoint.skill = {};
    _addCloneRRMEntryPoint.version = {};
    ...
    _addCloneRRMEntryPoint.saveComments = function () {
        ...
        if (updatecomments == 1) {
            ...
            _addCloneRRMEntryPoint.clearAll_addrrmdata();
        }
    ...
    _addCloneRRMEntryPoint.toggleTabRRMEntry = function () {
            ...
            if (requirmentName.trim() == "" || requireFor.trim() == "" || position == "" || position == "0" || department == "" || designation == "" || experience == "" || experience == "0" || interviewers.length == 0 || priority == null || priority == "") {
                ...
                PostDataCallAsync(dataResource, function (resultResorce) {
                    if (ResourceRequirementId == null) {
                        ...
                        _addCloneRRMEntryPoint.saveRRMInterviewers(ResourceRequirementId, joinInterviewerArray)
                        if (IsRRMForClone == true) {
                            _addCloneRRMEntryPoint.saveSkillsDetailsForClone(ResourceRequirementId, ClonedRRMId);
                        }
                    }
                });
                ...
                if (IsRRMForClone != true) {
                    _addCloneRRMEntryPoint.getSkillsDetails();
                }
            }
        }
        $(".btnPrevious").show();
        if (!IsRrmSaved) {
            ...
            if (activeTab == "rrm_skillsTab") {
                ...
                if (($("#rrm_profileEntry_skills").val() == "" || $("#rrm_profileEntry_skills").val() == 0) && data.length == 0) {
                    ...
                    _addCloneRRMEntryPoint.insert_SkillInfoEntrysNew(result);
    ...
    _addCloneRRMEntryPoint.toggleTabRRMEntryPrevious = function () {
        ...
        if (activeTab == "rrm_skillsTab") {
            ...
            if(LoggedUser != requiredLead){
              ...
              _addCloneRRMEntryPoint.updateresourcerequitementdata();
        }
        if (activeTab == "rrm_skillsplanbTab") {
            $('.nav-tabs a[href="#rrm_SkillsPlanADetails"]').tab("show");
            $("a.btnNext").show();
    ...
    _addCloneRRMEntryPoint.updateresourcerequitementdata = function () {
        ...
        callGetListAsync('GetRRMbyid', '{"IsActive":"True","ResourceRequirementId":"' + ResourceRequirementId + '","Token":"' + Token + '"}', function (getRRMData) {
            _addCloneRRMEntryPoint.mapupdateaddrrmListcomputeHTML(getRRMData)
        })
    }

    //bind rrm data from _addCloneRRMEntryPoint.updateresourcerequitementdata function result
    _addCloneRRMEntryPoint.mapupdateaddrrmListcomputeHTML = function (getRRMData) {
    ...
    //rrmFormVAlidation
    _addCloneRRMEntryPoint.rrmValidation = function () {
    ...
    //reset skill data 
    _addCloneRRMEntryPoint.skillsClearAndShow = function () { // Clear our fields

    }

    //insert skill details New
    _addCloneRRMEntryPoint.insert_SkillInfoEntrysNew = function (e) {
    ...
    _addCloneRRMEntryPoint.insert_SkillInfoEntry = function (e) {
        var skill_version = value.versionId;
        var family = value.familyId;
        var skill = value.skillId;
        ...
        PostDataCallAsync(data, function (postCall) {
            ...
            if (postCall['IsSuccess'] == true) {
                _addCloneRRMEntryPoint.skillsClearAndShow();
                _addCloneRRMEntryPoint.getSkillsDetails();
            }
        });
    }

    _addCloneRRMEntryPoint.update_SkillInfoEntry = function (e) {
    ...
    _addCloneRRMEntryPoint.delete_SkillInfoEntry = function (e) {
        var resource_requirement_skill_id = e.data.ResourceRequirementSkillId;
        data = {
    ...
    _addCloneRRMEntryPoint.getSkillsDetails = function () {
        ...
        callGetListAsync('GetResourceRequrirementSkill', filterData, function (e) {
            ...
            $("#sdgd-rrmOwnerSkills").dxDataGrid({
                ...
                onRowInserted: function (e) {
                    _addCloneRRMEntryPoint.insert_SkillInfoEntry(e);
                },
                onRowUpdated: function (e) {
                    _addCloneRRMEntryPoint.update_SkillInfoEntry(e);
                },
                onRowRemoved: function (e) {
                    _addCloneRRMEntryPoint.delete_SkillInfoEntry(e);
                }
            });
        })
    ...
    _addCloneRRMEntryPoint.saveRRMInterviewers = function (ResourceRequirementIdParam, EmployeeIds) {
    ...
    _addCloneRRMEntryPoint.skillcomputeHTML = function (getSkillList) {
        var html = "";
        ...
        if (getSkillList == null || getSkillList == "" || getSkillList == undefined) {
            ...
            getSkillList.forEach(function (key, item) {
                ...
                html += "<button class='btn delete-btn' onclick=_addCloneRRMEntryPoint.deleteRow_SkillMapping('" + skillId + "')><i class='fas fa-trash-alt'></i></button></td>"
                html += "</tr>";
            });
    ...
    _addCloneRRMEntryPoint.loadSkillGrid = function (getSkillList) {
        $("#sdgd-rrmOwnerSkills").dxDataGrid({ dataSource: getSkillList })
    }

    //reset form data
    _addCloneRRMEntryPoint.clearAll_addrrmdata = function () {
    ...
    _addCloneRRMEntryPoint.saveSkillsDetailsForClone = function (ResourceRequirementId, ClonedRRMId) {
        var filterValue = {
