RRMCloneEntryPointGridOwner= (function (pageId) {
    var _rrmGrid = {};
    _rrmGrid.ui = {};
    ...
    function initialize() {
        ...
        callGetListAsync('GetClosedRRM', filterData, function(e){
            //candidatesForRRM = e;
    ...
    _rrmGrid.renderrrmentrypointreportGrid = function () {
        var dataGrid = _rrmGrid.ui.rrmGridReport.dxDataGrid({   
            ...
            onRowExpanded:function(e){
                loadMasterDetailsCountRRMEntry(e.key);
            },
            ...
            columns: [
                ...
                },
                {
                    ...
                    cellTemplate: function (container, options) {
                        $("<div>")
                            // .append("<button data-type='edit' data-rrmid =" + options.data.RRMId + "  data-rrmtype =" + options.data.ResourceRequirementType + " data-rrmownerid ="+ options.data.OwnerId+" class='btn btn-xs btn-primary edit-btn btnSelect editCloneRRMEntryPoint" + pageId + "' title='Edit RRM'><i class='fas fa-pencil-alt'></i></button>")
                            .append("<button data-type='edit' data-rrmid =" + options.data.RRMId + "  data-rrmtype =" + options.data.ResourceRequirementType + " data-rrmownerid ="+ options.data.OwnerId+" class='btn btn-xs btn-primary edit-btn btnSelect" + pageId + "' title='Open RRM' onclick=OpenRRMCloneEntry(\'"+ options.data.RRMId +"\',\'"+ options.data.RRMNo +"\')><i class='fas fa-lock-open'></i></button>")
                            // .append("<button data-type='add' data-rrmid =" + options.data.RRMId + "  data-rrmtype =" + options.data.ResourceRequirementType + " data-rrmownerid ="+ options.data.OwnerId+" class='btn btn-xs btn-primary edit-btn btnSelect cloneRRMEntryPointOwner" + pageId + "' title='Clone RRM'><i class='fas fa-clone'></i></button>")
                            // .append("<button data-type='comment' data-rrmid =" + options.data.RRMId + "  data-rrmtype =" + options.data.ResourceRequirementType + " data-rrmownerid ="+ options.data.OwnerId+" class='btn btn-xs btn-primary edit-btn btnSelect commentsRRMEntryPoint' title='Comments RRM' onclick=GetRRMCloneCommentsEntryPoint(\'"+ options.data.RRMId +"\',\'"+ options.data.RRMNo +"\')><i class='fas fa-comments'></i></button>")
                            .appendTo(container);
                    },
                    onClick: function (e) {
            ...
            masterDetail: {
                ...
                template: function(container, options) { 
                    ...
                    $("<div>")
                        ...
                        html += "<div class='cardDetailsTrackerNew'> <div class='item'><div class='card item-card card-block'><h5 class='mt-3 mb-3'><b>INTERVIEWS</b></h5><h2 id='cardInterviewsRRMNew"+options.data.RRMId+"'>NA</h2></div></div>"
                        html += "<div class='item'><div class='card rrmEntryPointRecommended item-card card-block'><h5 class='mt-3 mb-3'><b>RECOMMENDED</b></h5><h2 id='cardRecommendedRRMNew"+options.data.RRMId+"'>NA</h2></div></div>"
                        html += "<div class='item'><div class='card rrmEntryPointNotRecommended item-card card-block'><h5 class='mt-3 mb-3'><b>NOT-RECOMMENDED</b></h5><h2 id='cardNotRecommendedRRMNew"+options.data.RRMId+"'>NA</h2></div></div>"
                        html += "</div></div>"
                        ...
                        html += "<div class='item'><div class='card rrmEntryPointL1InterviewsScheduled item-card card-block'><h5 class='mt-3 mb-3'><b>L1-Interviews Scheduled</b></h5><h2 id='cardL1InterviewsScheduledRRMNew"+options.data.RRMId+"'>NA</h2></div></div>"
                        html += "<div class='item'><div class='card rrmEntryPointL1InterviewsConducted item-card card-block'><h5 class='mt-3 mb-3'><b>L1-Interviews Conducted</b></h5><h2 id='cardL1InterviewsConductedRRMNew"+options.data.RRMId+"'>NA</h2></div></div>"
                        html += "<div class='item'><div class='card rrmEntryPointL2InterviewsScheduled item-card card-block'><h5 class='mt-3 mb-3'><b>L2-Interviews Scheduled</b></h5><h2 id='cardL2InterviewsScheduledRRMNew"+options.data.RRMId+"'>NA</h2></div></div>"
                        html += "<div class='item'><div class='card rrmEntryPointL2InterviewsConducted item-card card-block'><h5 class='mt-3 mb-3'><b>L2-Interviews Conducted</b></h5><h2 id='cardL2InterviewsConductedRRMNew"+options.data.RRMId+"'>NA</h2></div></div>"
    ...
    function loadMasterDetailsCountRRMEntry(RRMId){
        ...
        callGetListAsync('GetCardDetailsForTrackerNewRRMEntryPoint', filterData, function (data) {
            if(data!=undefined && data.length>0){
                $("#cardInterviewsRRMNew"+RRMId).html(data[0].Interviews);
                $("#cardRecommendedRRMNew"+RRMId).html(data[0].Recommended);
                $("#cardNotRecommendedRRMNew"+RRMId).html(data[0].NotRecommended);
            }
        });
        callGetListAsync('GetAllRRMCountByRRMId', filterData, function (data) {
            if(data!=undefined && data.length>0){
                $("#cardL1InterviewsScheduledRRMNew"+RRMId).html(data[0].L1InterviewScheduled);
                $("#cardL1InterviewsConductedRRMNew"+RRMId).html(data[0].L1InterviewConducted);
                $("#cardL2InterviewsScheduledRRMNew"+RRMId).html(data[0].L2InterviewScheduled);
                $("#cardL2InterviewsConductedRRMNew"+RRMId).html(data[0].L2InterviewConducted);                
                $("#cardOfferMadeRRMNew"+RRMId).html(data[0].OfferMade);
                $("#cardOfferAcceptedRRMNew"+RRMId).html(data[0].offerAccepted);
            }
        });
...
function exportSingleRRMEntry(data,e){
    ...
    var skillCloneGrid = $("#skillForRRMCloneExport").dxDataGrid("instance");
    ...
    setTimeout(() => {
        DevExpress.excelExporter.exportDataGrid({
            ...
            workbook.xlsx.writeBuffer().then(function (buffer) {
                ...
                $("#skillForRRMCloneExport").dxDataGrid("instance").dispose();
            });
        });
    }, 500);
...
function getRRMSkillsForExport(rrmId){
    ...
    $("#skillForRRMCloneExport").dxDataGrid({
...
function GetRRMCloneCommentsEntryPoint(RRMId,RRMNo){
    ...
    var editor = CKEDITOR.instances.sd_Clone_txtEditor_RRMComments_common;
        if (editor) {
            editor.destroy(true);
        }
        $("#sd_Clone_txtEditor_RRMComments_common").dxHtmlEditor('instance').option('value',"");

}

function  OpenRRMCloneEntry(RRMId,RRMNo){
    OPenRRMId=RRMId;
    $('#rrm_OpenClosedRRM').appendTo("body").modal("show");
    if(RRMNo != null && RRMNo !="" && RRMNo !=undefined){
        $("#OpenRRMEntryRRMNo").html("- " +RRMNo);
    }  
    getCloneManageCommonCommentHistory(RRMId);
    renderReopenRRMDropdownlist();
    var editor = CKEDITOR.instances.sd_Clone_txtEditor_RRMComments_common;
        if (editor) {
            editor.destroy(true);
        }
        $("#sd_Clone_txtEditor_RRMComments_common").dxHtmlEditor('instance').option('value',"");
    bindOpenCloneCommonForRRMComments();
    $("#divRRMReopenStatus").dxSelectBox('instance').reset()
}


function getCloneManageCommonCommentHistory(ResourceRequirementId) {
    ...
    callGetListAsync('GetCommentsInResourceRequirement', filter_val, function (getManageplanComments) {
        ...
        $("#rrm_clone_plan_comments_documents").show();
        $("#rrm_clone_plan_comments_documents").html(plan_comment_history_html);
        var div = document.getElementById('rrm_clone_plan_comments_documents');
        div.scrollTop = div.scrollHeight - div.clientHeight;
    })
}

function bindOpenCloneCommonForRRMComments(){
    
    var commentsEditor = $("#sd_clone_txtEditor_common").dxHtmlEditor({
        height: 300,
        toolbar: {
            items: [
                "undo", "redo", "separator",
    ...
    var mentionToolTipRRM = $("#sd_clone_RRMmentions_common").dxPopover({
...
function bindCloneCommonForRRMComments(){
    
    var commentsEditor = $("#sd_Clone_txtEditor_RRMComments_common").dxHtmlEditor({
        height: 300,
        toolbar: {
            items: [
                "undo", "redo", "separator",
...
function saveCommonComments(){
    var finalComments = $("#sd_Clone_txtEditor_RRMComments_common").dxHtmlEditor('instance').option('value');
...
function closeRRMCommon(){
    ...
    var editor = CKEDITOR.instances.sd_Clone_txtEditor_RRMComments_common;
        ...
        CKEDITOR.replace('sd_Clone_txtEditor_RRMComments_common');
}

function renderReopenRRMDropdownlist() {
    var filterData = JSON.stringify({
        "Token":Token,
    });
    callGetListAsync('GetRRMReOpenDropDown', filterData, function(data){
        $('#divRRMReopenStatus').dxSelectBox({
            dataSource: data,
            displayExpr: 'Name',
            valueExpr: 'RRMReOpenId',
            placeholder: 'Choose Reason',
            showClearButton: true,
            onValueChanged(data) {
                if(data.value !=""){
                    $('#rrm_RRMReopenStatusError').html("");
                }
              },
          }).dxValidator({
            validationRules: [{
...
function saveOpenClosedRRM(){
    var opencomment = $("#sd_clone_txtEditor_common").dxHtmlEditor('instance').option('value');
    var openStatusId =$('#divRRMReopenStatus').dxSelectBox('instance').option('value');
    var rrmReopenStatus =$('#divRRMReopenStatus').dxSelectBox('instance').option('text');
    if(openStatusId=="" ||  openStatusId == null  || openStatusId == undefined ){
        $('#rrm_RRMReopenStatusError').html("Select Open RRM Reason");
    }  else {
        $('#rrm_RRMReopenStatusError').html("");
        if (opencomment == "" || opencomment == null || opencomment == undefined) {
            swal({
                title: "Warning!",
                text: "Please Add Comments",
                icon: "warning",
        ...
        var dataComment = {
            "Method": "PostRRMReOpenStatus",
            "Data": {
                "Token": Token,
                "ResourceRequirementId": OPenRRMId,
                "StatusId":openStatusId,
                "ReopenComments": rrmReopenStatus.toString()+" - " + opencomment.toString(),
            }
        }
        PostDataCallAsync(dataComment, function (resultComments) {
            if (resultComments['IsSuccess'] == true) {
            ...
            $("#rrm_clone_plan_comments_documents").empty();
            getCloneManageCommonCommentHistory(OPenRRMId);
            $("#sd_clone_txtEditor_common").dxHtmlEditor('instance').option('value',"");
            $("#rrmGridReportClosed").dxDataGrid('instance').refresh();
            $('#rrm_OpenClosedRRM').modal("hide");
            PageCloneInitializeOwner("Closed")
        }   
        else{
            swal({
                title: "Warning!",
